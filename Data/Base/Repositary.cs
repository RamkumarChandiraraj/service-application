...
namespace Data.Base
{
    public class Repository<T>(ServiceApplicationDbContext context) : IRepositary<T> where T : class
    {
        public readonly ServiceApplicationDbContext _context = context;
        ...
        public virtual async ValueTask SaveChangesAsync(T entity)
        {
            await _context.SaveChangesAsync();
        }
